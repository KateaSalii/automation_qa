...
class TestElements:
    ...
    class TestWebTable:
        ...
        @allure.title('Check the ability to add person in the table')
        ...
        @allure.title('Check the ability to search person in the table')
        ...
        @allure.title('Check the ability to update person info')
        ...
        @allure.title('Check the ability to delete a person from the table')
    ...
    class TestLinkPage:
        ...
        @allure.title('Checking broken link')
    ...
    class TestDynamicPropertiesPage:
        ...
        def test_dynamic_properties(self, driver):
            ...
            assert color_after != color_before, 'the color did not changed'
        ...
        def test_enable_button(self, driver):
            ...
            assert enable is True, 'button did not been enable after 5 seconds'
