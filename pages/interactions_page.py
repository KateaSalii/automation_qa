...
class ResizablePage(BasePage):
    ...
    @allure.step("get px from wight and height")
    ...
    def change_size_resizable(self):
        ...
        elem = self.element_is_present(self.locators.RESIZABLE)
...
class DragabblePage(BasePage):
    ...
    @allure.step("axis resticted x")
    def axis_resticted_x(self):
    ...
    @allure.step("axis resticted y")
    def axis_resticted_y(self):
        self.element_is_visible(self.locators.AXIS_TAB).click()
