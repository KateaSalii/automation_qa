...
class TextBoxPage(BasePage):
    ...
    @allure.step("checking filling form")
...
class WebTablePage(BasePage):
    ...
    @allure.step("check search some person")
...
class ButtonsPage(BasePage):
    ...
    @allure.step("click on different buttons: double, right, click")
...
class DynamicPropertiesPage(BasePage):
    ...
    @allure.step("check changing color")
    ...
    @allure.step("check appearing of the button")
    def check_appear_of_button(self):
        try:
            self.element_is_visible(self.locators.VISIBLE_AFTER_FIVE_SECONDS)
        except TimeoutException:
            return False
        return True
